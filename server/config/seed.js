...
var _asset = require('../api/asset/asset.model');

var _asset2 = _interopRequireDefault(_asset);

var _log = require('../api/log/log.model');
...
_asset2.default.find({}).remove().then(function () {
...
_log2.default.find({}).remove().then(function () {
  var d = new Date(100000);
  _log2.default.create({
